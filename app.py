...
def artist_songs(artist):
    ...
    if response.status_code != 200:
        logging.error(f"Failed to fetch artist data from Genius API: {response.status_code}")
        return render_template('error.html', message="Failed to fetch artist data from Genius API.")
